...
When you are finished, from the branch on which you are working, commit your changes and open a pull request to have the changes integrated into the repository you forked.
